...
namespace Uml4Net.Codex.Tools.Hook
{
    ...
    public static class CheckResultSummarizer
    {
        ...
        public static string? Summarize(CheckResult? result)
        {
            ...
            {
                return "uml4net-codex: no UML knowledge base has been fetched yet. If the user asks a UML question, " +
                       "offer to run `uml4net-codex fetch --version 2.5.1` then `uml4net-codex generate --version 2.5.1` " +
            ...
            {
                return $"uml4net-codex: UML {result.Default} is fetched but not generated yet. Run " +
                       $"`uml4net-codex generate --version {result.Default}` before answering UML questions from the knowledge base.";
            }

            if (!defaultEntry.SpecGenerated)
            {
                return $"uml4net-codex: UML {result.Default} metamodel/standard-profile knowledge base is ready. " +
