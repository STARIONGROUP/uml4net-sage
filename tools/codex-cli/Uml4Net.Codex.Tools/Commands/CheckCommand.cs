...
namespace Uml4Net.Codex.Tools.Commands
{
    ...
    /// <summary>
    /// <c>uml4net-codex check</c>: a fully offline, file-existence-only status check - no network call,
    ...
    public static class CheckCommand
    {
        ...
        public static Command Build()
        {
            ...
            command.SetAction(parseResult =>
            {
                ...
                {
                    AnsiConsole.MarkupLineInterpolated($"No UML version fetched yet. Run 'uml4net-codex fetch --version {KnownUmlVersions.Current.Version}'.");
                    return 0;
                }
                ...
                {
                    AnsiConsole.MarkupLineInterpolated($"UML {manifest.Default} is fetched but not generated. Run 'uml4net-codex generate --version {manifest.Default}'.");
                    return 0;
                }
