...
namespace Uml4Net.Codex.Tools.Hook.Tests
{
    ...
    public class CacheLayoutTests
    {
        ...
        {
            var first = CacheLayout.InstallKey(@"C:\repo\uml4net-codex");
            var second = CacheLayout.InstallKey(@"C:\repo\uml4net-codex");
        ...
        {
            var directory = CacheLayout.CliDirectoryFor(@"C:\repo\uml4net-codex", "1.0.0", "win-x64");

            Assert.That(directory, Does.Contain("1.0.0"));
            Assert.That(directory, Does.Contain("win-x64"));
            Assert.That(directory, Does.Contain(CacheLayout.InstallKey(@"C:\repo\uml4net-codex")));
