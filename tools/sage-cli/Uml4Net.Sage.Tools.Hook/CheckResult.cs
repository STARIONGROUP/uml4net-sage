...
namespace Uml4Net.Sage.Tools.Hook
{
    ...
    /// <summary>
    /// Mirrors the JSON shape of <c>uml4net-sage check --json</c>'s output (defined independently here,
    /// not by referencing <c>Uml4Net.Sage.Knowledge</c>, so this hook stays dependency-free - see the
